...
import 'package:object_detection/Recognition.dart';
import 'package:object_detection/main.dart';
import 'package:object_detection/stats.dart';
...
class Classifier {
  ...
  Future _speak(String predict) async {
    if (lastPrediction != predict) {
      var result = await flutterTts.speak("this is $predict");
  ...
  Future<Map<String, dynamic>>? predict(imageLib.Image image) async{
    ...
    if(recognitions.isNotEmpty) {
      await _speak(recognitions[0].label);
